...
// import 'package:Kohr_Admin/screens/hire/widgets/job_card_widget.dart';
// import 'package:cloud_firestore/cloud_firestore.dart';
// import 'package:flutter/material.dart';
// import 'package:page_transition/page_transition.dart';
// import 'package:provider/provider.dart';
// import '../../constants.dart';
// import 'controller/hire_dasbord_provider.dart';
// import 'job_detail_screen.dart';
// import 'job_form.dart';
//
// class HireDashboard extends StatelessWidget {
//   const HireDashboard({super.key});
//
//   @override
//   Widget build(BuildContext context) {
//     final provider = Provider.of<HireDashboardProvider>(context, listen: false);
//
//     return Scaffold(
...
//                   }
//
//                   final categorizedJobs =
//                       provider.categorizeJobs(snapshot.data!.docs);
//                   final allJobs = [
//                     ...categorizedJobs['activeJobs']!,
//                     ...categorizedJobs['closedJobs']!,
//                   ];
//
//                   return ListView.builder(
//                     shrinkWrap: true,
//                     //padding: const EdgeInsets.symmetric(horizontal: 16.0),
//                     itemCount: allJobs.length + 1,
//                     itemBuilder: (context, index) {
//                       if (index == 0) {
//                         return Padding(
//                           padding: const EdgeInsets.all(10.0),
...
//                       }
//
//                       final job = allJobs[index - 1];
//                       return GestureDetector(
//                         onTap: () => Navigator.push(
//                           context,
//                           MaterialPageRoute(
//                             builder: (_) => JobDetailsScreen(jobData: job),
//                           ),
//                         ),
//                         child: JobCard(
//                           job: job,
//                           onUpdateStatus: (isPublished) =>
