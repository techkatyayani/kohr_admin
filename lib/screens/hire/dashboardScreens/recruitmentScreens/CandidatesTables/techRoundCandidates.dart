...
import '../widgets/techRecruiter.dart';

class TechnicalCandidateTable extends StatefulWidget {
  final String jobId;
  ...
  @override
  State<TechnicalCandidateTable> createState() => _TechnicalCandidateTableState();
}

class _TechnicalCandidateTableState extends State<TechnicalCandidateTable> {
  ...
  //       //.where('techRoundStatus', isEqualTo: null)
  //       .snapshots()
  //       .map((snapshot) {
  ...
  Stream<List<Map<String, dynamic>>> fetchApplications(String jobId) {
    return FirebaseFirestore.instance
      ...
      return snapshot.docs.where((doc) {
        final techRoundStatus = doc['techRoundStatus'];
        return techRoundStatus == null || techRoundStatus== 'Rejected'; // Filter out if callStatus is "Selected"
      }).map((doc) {
        final data = doc.data() as Map<String, dynamic>;
        data['applicationId'] = doc.id; // Add the document ID
        return data;
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        _buildHeaderText("Hr RoundStatus", 160),
                        _buildHeaderText("Tech.Interview By", 150),
                        ...
                        Container(
                          ...
                          child: Row(
                            children: [
                              ...
                              SizedBox(width: 150, child: Text(rowData['assessmentStatus'] ?? "N/A", textAlign: TextAlign.center,
                                  style: TextStyle(
                              ...
                              SizedBox(width: 160, child: Text(rowData['techRoundStatus'] ?? "N/A", textAlign: TextAlign.center,
                                  style: TextStyle(
                              ...
                              TechRecruiterDropdown(
                                initialValue: rowData['techRecruiter'], // Pass the current recruiter value
                                jobId: widget.jobId, // Pass the jobId
                                applicationId: rowData['applicationId'], // Pass the applicationId
                                recruiters: ['Vaibhaw', 'Praveen', 'Saksham'], // You can make this dynamic
