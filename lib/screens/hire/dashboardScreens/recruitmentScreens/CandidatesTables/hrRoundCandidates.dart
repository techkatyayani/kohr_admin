...
import '../widgets/hrRecruiter_dropdown.dart';
import '../widgets/recruiter_dropdown.dart';

class HRCandidateTable extends StatefulWidget {
  final String jobId;
  ...
  @override
  State<HRCandidateTable> createState() => _HRCandidateTableState();
}

class _HRCandidateTableState extends State<HRCandidateTable> {
                  ...
                  child: Container(
                    ...
                    child: Row(
                      children: [
                        ...
                        _buildHeaderText("HR Round Status", 150),
                        _buildHeaderText("Final Status", 160),
                        _buildHeaderText("HR Interview By", 150),
