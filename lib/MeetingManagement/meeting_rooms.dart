            ...
            children: [
              ...
              ListView.builder(
                ...
                itemBuilder: (context, index) {
                  ...
                  final availableTimings = data['availableTimings'] as Map<String, dynamic>?;
                                  ...
                                  children: [
                                    Row(
                                      children: [
                                        ...
                                        const Spacer(),
                                        IconButton(
                                          icon: const Icon(Icons.edit, color: Color(0xff09254A)),
                                          onPressed: () {
                                            Navigator.push(
                                              context,
                                              MaterialPageRoute(
                                    ...
                                    if (data['specifications'] != null)
                                      Wrap(
                                        spacing: 8,
                                        runSpacing: 8,
                                        children: (data['specifications'] as List)
                                            .map((spec) => Chip(
                                              label: Text(
                                                spec.toString(),
                                                style: const TextStyle(
                                              ...
                                              backgroundColor: const Color(0xff09254A).withOpacity(0.1),
                                              shape: RoundedRectangleBorder(
